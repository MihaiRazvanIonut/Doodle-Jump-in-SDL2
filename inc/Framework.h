...
/*
 * I've found a bug with the way that the game initialises the fullscreen mode in the run function
 * At least for my computer it would not start the game properly
 * changed from SDL_WINDOW_FULLSCREEN to SDL_WINDOW_FULLSCREEN_DESKTOP
 *
 *
 *
 */
